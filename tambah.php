...
<nav class="bg-primary fixed-top">
    ...
    <h1 class="text-center" style="font-size: 30px;">Tambah data kamar hotel</h1>
    <form action="" method="post">
  <div class="form-group">
    <label for="jenis">Jenis Kamar Hotel</label>
    <input type="text" class="form-control" id="jenis" name="jenis" placeholder="Masukkan Jenis Kamar Hotel">
    <label for="fasilitas">Fasilitas Kamar Hotel</label>
    <input type="text" class="form-control" id="fasilitas" name="fasilitas" placeholder="Masukkan Fasilitas Kamar Hotel">
    <label for="harga">Harga Kamar Hotel</label>
    <input type="number" class="form-control" id="harga" name="harga" placeholder="Masukkan Harga Kamar Hotel">
    <label for="gambar">Gambar Kamar Hotel</label>
    <input type="text" class="form-control" id="gambar" name="gambar" placeholder="Masukkan Gambar Kamar Hotel">
  </div>
